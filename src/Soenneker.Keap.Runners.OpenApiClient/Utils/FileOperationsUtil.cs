...
using Soenneker.Keap.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Keap.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Keap:ClientGenerationUrl"] ?? "https://crm.infusionsoft.com/app/v3/api-docs/V2";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Keap OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "KeapOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
